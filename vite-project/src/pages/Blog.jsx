...
const Blog = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!input.title || !input.Blog || !input.author) {
      toast.error('Please fill all required fields (Title, Blog Content, and Author)');
      return;
    }
    ...
    try {
      const api = 'https://alic-backend.onrender.com/blog/create';
